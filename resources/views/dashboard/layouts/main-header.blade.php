					...
					<div class="main-header-right">
										...
										<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown"
											...
											@if (App::getLocale() == 'ar')
												<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
														src="{{URL::asset('Dashboard/img/flags/algeria_flag.jpg')}}" alt="img"></span>
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="nav-item full-screen fullscreen-button">
								<a class="new nav-link full-screen-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs"  viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-maximize"><path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"></path></svg></a>
							</div>
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>{{ trans('Dashboard/auth.profile') }}</a>
									<a class="dropdown-item" href=""><i class="bx bx-cog"></i> {{ trans('Dashboard/auth.edit_profile') }}</a>
									<a class="dropdown-item" href=""><i class="bx bxs-inbox"></i> {{ trans('Dashboard/auth.inbox') }}</a>
									<a class="dropdown-item" href=""><i class="bx bx-envelope"></i> {{ trans('Dashboard/auth.messages') }}</a>
									<a class="dropdown-item" href=""><i class="bx bx-slider-alt"></i> {{ trans('Dashboard/auth.account_settings') }}</a>
									<form method="POST" action="{{ route('logout') }}">
										@csrf
										
										<a class="dropdown-item" href="route('logout')" onclick="event.preventDefault();
									                                                this.closest('form').submit();"><i class="bx bx-log-out"></i> {{ trans('Dashboard/auth.logout') }}</a>
