				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('contracts.index') }}">{{ trans('main-sidebar_trans.contract-types') }}</a></li>
